...
/*
 * รอหลังลูกค้าพิมพ์ข้อความล่าสุด (quiet window)
 *
 * ⚠️ ค่านี้ยิ่งยาว ยิ่งเสี่ยงกับอายุ reply token ของ LINE
 * token มีอายุจำกัด และเวลาที่ใช้ไปทั้งหมดคือ quiet window + เวลาที่สมองร้านคิด (ถึง 12 วิ)
 * ถ้ารวมแล้วเลยอายุ token ขึ้นมา reply จะพัง — ตรงนั้นมีทางกู้ด้วย push แล้ว (ดู src/pipeline.js)
 * แต่ push กินโควตารายเดือน จึงไม่ควรให้กลายเป็นเส้นทางปกติ
 */
